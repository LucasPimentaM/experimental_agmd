...
PetscErrorCode InitialGuess(Vec x, SolverCtx *solver_ctx)
{
    ...
    x_array[7] = dessal_data.membrane_salinity;
    x_array[8] = dessal_data.out_salinity_feed;
    x_array[9] = dessal_data.membrane_gap_pressure;
    x_array[10] = dessal_data.mass_flux;
    x_array[11] = dessal_data.film_thickness;
    x_array[12] = dessal_data.heat_flux;
    x_array[13] = dessal_data.vapor_heat_flux;
    x_array[14] = dessal_data.feed_outflow_rate;
...
PetscErrorCode PlantBalances(SNES snes, Vec x, Vec f, void *ctx)
{
    ...
    dessal_data.membrane_salinity = x_array[7];
    dessal_data.out_salinity_feed = x_array[8];
    dessal_data.membrane_gap_pressure = x_array[9];
    dessal_data.mass_flux = x_array[10];
    dessal_data.film_thickness = x_array[11];
    dessal_data.heat_flux = x_array[12];
    dessal_data.vapor_heat_flux = x_array[13];
    dessal_data.feed_outflow_rate = x_array[14];
    ...
    f_array[7] = x_array[7] - dessal_data.membrane_salinity;
    f_array[8] = x_array[8] - dessal_data.out_salinity_feed;
    f_array[9] = x_array[9] - dessal_data.membrane_gap_pressure;
    f_array[10] = x_array[10] - dessal_data.mass_flux;
    f_array[11] = x_array[11] - dessal_data.film_thickness;
    f_array[12] = x_array[12] - dessal_data.heat_flux;
    f_array[13] = x_array[13] - dessal_data.vapor_heat_flux;
    f_array[14] = x_array[14] - dessal_data.feed_outflow_rate;
