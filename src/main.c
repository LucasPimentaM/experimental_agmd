/*
Computational code for a simple, reduced model for the analysis of vacuum-enhanced air gap membrane distillation (V-AGMD) desalination bench-scale modules

Contributors:
Kleber Marques Lisboa, Laboratory of Thermal Sciences (LATERMO), Universidade Federal Fluminense

Acknowledgements:
This work was funded by QatarEnergy, TotalEnergies, and FAPERJ
*/
